...
def generateQuestionAnswers(resume_text, qa_jd):
    prompt_parts = [ f"""
    Generate a set of interview questions and ideal answers for a job position based on the provided Job Description and the candidate's Resume. The Job Description emphasizes key skills, responsibilities, and qualifications. The candidate's Resume indicates proficiency in specific skills, experiences, and achievements.
